...
void HALSimWSProviderRoboRIO::Initialize(WSRegisterFunc webRegisterFunc) {
  CreateSingleProvider<HALSimWSProviderRoboRIO>(
      "RoboRIO", webRegisterFunc);
}

void HALSimWSProviderRoboRIO::RegisterCallbacks() {
  m_fpgaCbKey = HALSIM_RegisterRoboRioFPGAButtonCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">fpga_button", static_cast<bool>(value->data.v_boolean)}});
  }, this, true);

  m_vinVoltageCbKey = HALSIM_RegisterRoboRioVInVoltageCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">vin_voltage", value->data.v_double}});
  }, this, true);

  m_vinCurrentCbKey = HALSIM_RegisterRoboRioVInCurrentCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">vin_current", value->data.v_double}});
  }, this, true);
  
  m_6vVoltageCbKey = HALSIM_RegisterRoboRioUserVoltage6VCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">6v_voltage", value->data.v_double}});
  }, this, true);

  m_6vCurrentCbKey = HALSIM_RegisterRoboRioUserCurrent6VCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">6v_current", value->data.v_double}});
  }, this, true);

  m_6vActiveCbKey = HALSIM_RegisterRoboRioUserActive6VCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">6v_active", static_cast<bool>(value->data.v_boolean)}});
  }, this, true);

  m_6vFaultsCbKey = HALSIM_RegisterRoboRioUserFaults6VCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">6v_faults", value->data.v_int}});
  }, this, true);

  m_5vVoltageCbKey = HALSIM_RegisterRoboRioUserVoltage5VCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">5v_voltage", value->data.v_double}});
  }, this, true);

  m_5vCurrentCbKey = HALSIM_RegisterRoboRioUserCurrent5VCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">5v_current", value->data.v_double}});
  }, this, true);

  m_5vActiveCbKey = HALSIM_RegisterRoboRioUserActive5VCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">5v_active", static_cast<bool>(value->data.v_boolean)}});
  }, this, true);

  m_5vFaultsCbKey = HALSIM_RegisterRoboRioUserFaults5VCallback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">5v_faults", value->data.v_int}});
  }, this, true);

  m_3v3VoltageCbKey = HALSIM_RegisterRoboRioUserVoltage3V3Callback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">3v3_voltage", value->data.v_double}});
  }, this, true);

  m_3v3CurrentCbKey = HALSIM_RegisterRoboRioUserCurrent3V3Callback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">3v3_current", value->data.v_double}});
  }, this, true);

  m_3v3ActiveCbKey = HALSIM_RegisterRoboRioUserActive3V3Callback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
        {{">3v3_active", static_cast<bool>(value->data.v_boolean)}});
  }, this, true);

  m_3v3FaultsCbKey = HALSIM_RegisterRoboRioUserFaults3V3Callback([](const char* name, void* param, const struct HAL_Value* value) {
    static_cast<HALSimWSProviderRoboRIO*>(param)->ProcessHalCallback(
